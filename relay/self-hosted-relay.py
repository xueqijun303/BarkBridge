...
.page-menu,.action-menu{position:relative}.page-menu summary,.action-menu summary{list-style:none;cursor:pointer;min-height:42px;border:1px solid var(--line);border-radius:8px;background:var(--panel);color:var(--text);display:grid;place-items:center;padding:0 14px;font-weight:900}.page-menu summary::-webkit-details-marker,.action-menu summary::-webkit-details-marker{display:none}.page-menu[open] summary,.action-menu[open] summary{border-color:var(--green);color:var(--green)}
.menu-panel{position:absolute;right:0;top:calc(100% + 8px);z-index:10;min-width:158px;border:1px solid var(--line);border-radius:8px;background:var(--panel);box-shadow:0 14px 34px rgba(0,0,0,.14);padding:8px;display:grid;gap:6px}.menu-panel a,.menu-panel button{min-height:44px;border:0;border-radius:8px;background:#edf5f3;color:var(--text);font:16px inherit;font-weight:850;text-align:left;padding:0 12px;display:flex;align-items:center}.menu-panel button{width:100%;cursor:pointer}.action-panel{position:static;box-shadow:none;min-width:0}
...
.actions{margin-bottom:10px}.actions .action-menu summary{background:var(--green);border-color:var(--green);color:#fff}.actions .menu-panel button:nth-child(2),.actions .menu-panel button:nth-child(4){background:#eef1f0}.toast{min-height:22px;margin:0 0 10px;color:var(--muted);font-size:14px}
...
.app{height:100dvh;min-height:100svh;display:grid;grid-template-rows:auto auto minmax(0,1fr) auto;overflow:hidden}.chat-app{grid-template-rows:auto auto auto minmax(0,1fr) auto}
...
.topbar{display:grid;grid-template-columns:minmax(0,1fr) auto;gap:10px;align-items:center}.page-menu,.action-menu{position:relative}.page-menu summary,.action-menu summary{list-style:none;cursor:pointer;min-height:40px;border:1px solid #46505a;border-radius:8px;background:#2a2d31;color:var(--text);display:grid;place-items:center;padding:0 12px;font:15px inherit;font-weight:900}.page-menu summary::-webkit-details-marker,.action-menu summary::-webkit-details-marker{display:none}.page-menu[open] summary,.action-menu[open] summary{border-color:var(--green);color:var(--green)}.menu-panel{position:absolute;right:0;top:calc(100% + 8px);z-index:20;min-width:162px;border:1px solid var(--line);border-radius:8px;background:#24282c;box-shadow:0 16px 36px rgba(0,0,0,.32);padding:8px;display:grid;gap:6px}.menu-panel a,.menu-panel button{min-height:44px;border:0;border-radius:8px;background:#2f3439;color:var(--text);font:16px inherit;font-weight:850;text-align:left;text-decoration:none;padding:0 12px;display:flex;align-items:center}.menu-panel button{width:100%;cursor:pointer}.action-panel{top:calc(100% + 8px)}.ghost{height:40px;border:1px solid #46505a;border-radius:8px;background:#2a2d31;color:var(--text);font:15px inherit;font-weight:800;padding:0 12px}.searches{display:grid;grid-template-columns:1fr 1fr;gap:8px;margin-top:10px}.search{width:100%;height:42px;border:1px solid var(--line);border-radius:8px;background:#2a2d31;color:var(--text);font:17px inherit;padding:0 12px}
.contacts{display:flex;gap:8px;overflow:auto;padding:10px 12px;background:var(--panel);border-bottom:1px solid var(--line)}
.compact-bar{display:grid;grid-template-columns:minmax(0,1fr) 108px 76px;gap:8px;align-items:center;background:var(--panel);border-bottom:1px solid var(--line);padding:8px 12px}.select-wrap{height:40px;display:grid;grid-template-columns:auto minmax(0,1fr);gap:8px;align-items:center;border:1px solid var(--line);border-radius:8px;background:#2a2d31;padding:0 10px;color:var(--muted);font-size:14px;font-weight:800}.select-wrap select{min-width:0;border:0;background:transparent;color:var(--text);font:16px inherit;font-weight:850;outline:none}.compact-bar .ghost,.compact-bar .action-menu summary{width:100%;min-width:0}.ghost.primary{background:var(--green);border-color:var(--green);color:#03150a}.ghost.danger{color:#ffd7d3}
...
@media(max-width:560px){.searches{grid-template-columns:1fr}.compact-bar{grid-template-columns:minmax(0,1fr) 96px 70px}.select-wrap{padding:0 8px}.select-wrap span{display:none}.ghost,.page-menu summary,.action-menu summary{font-size:14px;padding:0 8px}.menu-panel{min-width:176px}}
